""" 3D Convolutional Neural Network Estimator for MNIST, built with tf.layers."""
...
def cnn_model_fn(features, labels, mode):
  ...
  # For this 3D version our Pukoban levels are 16x16x16 pixels, and have one channel
...
def main(unused_args):
  ...
  DL_classifier = tf.estimator.Estimator(
      model_fn=cnn_model_fn, model_dir="/tmp/Classifier2/3D")
